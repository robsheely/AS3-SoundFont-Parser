...
package com.ferretgodmother.soundfont.chunks.data.operators
{
    ...
    public class KeyNumToVolumeEnvelopeDecay extends ValueOperator
    {
        public function KeyNumToVolumeEnvelopeDecay(amount:int = 0)
        {
            super(Operator.KEYNUM_TO_RecordL_ENV_DECAY, amount);
        }
    }
}
