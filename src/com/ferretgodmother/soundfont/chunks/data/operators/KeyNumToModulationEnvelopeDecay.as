...
package com.ferretgodmother.soundfont.chunks.data.operators
{
    ...
    public class KeyNumToModulationEnvelopeDecay extends ValueOperator
    {
        public function KeyNumToModulationEnvelopeDecay(amount:int = 0)
        {
            super(Operator.KEYNUM_TO_MOD_ENV_DECAY, amount);
        }
    }
}
